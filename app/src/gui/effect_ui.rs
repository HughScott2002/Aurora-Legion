...
use crate::{
    ...
    gui::default_ui::{self, show_brightness, show_direction, show_effect_settings},
    gui::style::Theme,
    manager::profile::Profile,
};

pub fn show_effect_ui(ui: &mut egui::Ui, profile: &mut Profile, update_lights: &mut bool, theme: &Theme) {
